{==============================================================================}
{ Altium Diff Studio - Exporter Script v47                                           }
{                                                                              }
...
const
    SCRIPT_VERSION = 'v47';
    SCHEMA_VERSION = 'ads-json-v47';
    SCHEMATIC_SCHEMA_VERSION = 'v47';
...
begin
    Workspace := GetWorkSpace;
    if Workspace = nil then begin AppendExportLog('SCH v47 text association skipped: no workspace'); Exit; end;
    Project := Workspace.DM_FocusedProject;
    if Project = nil then begin AppendExportLog('SCH v47 text association skipped: no focused project'); Exit; end;

    Csv := TStringList.Create;
    Summary := TStringList.Create;
    Counters := TStringList.Create;
    try
        Csv.Add('sheetId;sheetName;sheetPath;objectIndex;componentClusterId;componentIndex;offsetFromComponent;objectId;knownType;v47RoleDecision;expectedTextKind;componentDesignatorText;componentCommentText;componentLibRef;textSource');
        Summary.Add('Altium schematic v47 component text association probe embedded in ExportDesignData');
        Summary.Add('Version=' + SCRIPT_VERSION);
        Summary.Add('Schema=' + SCHEMA_VERSION);
        Summary.Add('Project=' + Project.DM_ProjectFullPath);
        Summary.Add('OutputFolder=' + GetProjectPath);
        ...
        Summary.Add('CsvColumns=sheetId;sheetName;sheetPath;objectIndex;componentClusterId;componentIndex;offsetFromComponent;objectId;knownType;v47RoleDecision;expectedTextKind;componentDesignatorText;componentCommentText;componentLibRef;textSource');
        Summary.Add('');
        ...
        Summary.Add('Next step v48: once the association is confirmed, export displayObjects into schematic JSON, then probe geometry for 25/45/46.');

        CsvPath := GetProjectPath + TargetPrefix + ChangeFileExt(TargetFileName, '_sch_v47_text_association.csv');
        SummaryPath := GetProjectPath + TargetPrefix + ChangeFileExt(TargetFileName, '_sch_v47_text_association_summary.txt');
        Csv.SaveToFile(CsvPath);
        Summary.SaveToFile(SummaryPath);
        AppendExportLog('Saved SCH v47 text association CSV: ' + CsvPath);
        AppendExportLog('Saved SCH v47 text association summary: ' + SummaryPath);
    finally
        Csv.Free;
        Summary.Free;
        Counters.Free;
...
begin
    ...
    try
        ...
        OutputFileNames.Add(GetProjectPath + TargetPrefix + ChangeFileExt(TargetFileName, '_sch_v47_text_association.csv'));
        OutputFileNames.Add(GetProjectPath + TargetPrefix + ChangeFileExt(TargetFileName, '_sch_v47_text_association_summary.txt'));

...
begin
    ...
    try
        ...
        PcbBoard.BoardIterator_Destroy(Iterator); //  Corrigé : PcbBoard au lieu de Board
        JsonList.Add('  ],');
...
// Corrigé : Signature simplifiée sans argument "Parameters" pour s'aligner sur l'API OutJob d'Altium 26

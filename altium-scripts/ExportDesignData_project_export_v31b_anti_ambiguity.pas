{==============================================================================}
{ Altium Diff Studio - Exporter Script v31b                                         }
{                                                                              }
...
const
    SCRIPT_VERSION = 'v31b';
    SCHEMA_VERSION = 'ads-json-v31b';
    SCHEMATIC_SCHEMA_VERSION = 'v31b';
    PCB_OUTPUT_SUFFIX = '_pcb_v31b.json';
    constKindPcb = 'PCB';
...
begin
    ...
    JsonList.Add('      "schematicExportLevel": "logicalPlusFallbackGraphicsV31b",');
...
begin
    ...
    try
        ...
        JsonList.Add('  "exportGoal": "universalLogicalPlusGraphicsFallbackV31b",');

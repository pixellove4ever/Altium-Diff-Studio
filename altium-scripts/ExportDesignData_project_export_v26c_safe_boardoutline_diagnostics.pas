...
begin
    ...
    JsonList.Add('    "scriptVersion": "v26c",');
...
begin
    ...
    try
        ...
        JsonList.Add('    "boardOutline": "nativeBoardOutlineBoundingRectangleSafeNoVertexCalls",');
        JsonList.Add('    "polygons": "reserved",');
        JsonList.Add('    "splitPlanes": "reserved",');
        JsonList.Add('    "regions": "reserved",');
        JsonList.Add('    "notes": "V26c keeps the validated native Board.BoardOutline.BoundingRectangle path. Direct vertex APIs were tested but are not compile-compatible in this Altium version; next step is API discovery through a minimal diagnostic script or known interface documentation."');
        JsonList.Add('  },');
...
begin
    ...
    try
        ...
        JsonList.Add('  "type": "schematic",');
        AddExporterMetadata(JsonList);
        JsonList.Add('  "schemaVersion": "v26c",');

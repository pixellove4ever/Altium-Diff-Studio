...
begin
    ...
    { Try the most common count/property names first. }
    try
        VertexCount := OutlineObj.VerticesCount;
        SourceName := 'nativeBoardOutlineVertices';
    except
        VertexCount := 0;
    end;
    ...
    begin
        try
            VertexCount := OutlineObj.VertexCount;
            SourceName := 'nativeBoardOutlineVertexCount';
        except
            VertexCount := 0;
        end;
    end;
    ...
    begin
        try
            VertexCount := OutlineObj.PointCount;
            SourceName := 'nativeBoardOutlinePointCount';
        except
            VertexCount := 0;
        end;
    end;
...
begin
    ...
    JsonList.Add('    "scriptVersion": "v26",');
    JsonList.Add('    "schemaVersion": "ads-json-v26"');
    JsonList.Add('  },');
end;
...
begin
    ...
    JsonList.Add('      "schematicExportLevel": "logicalPlusFallbackGraphicsV26",');
    ...
    JsonList.Add('        "notes": "V26 keeps the universal schema stable. Native SCH primitive extraction should be enabled object family by object family after API validation in the target Altium version."');
    JsonList.Add('      }');
    JsonList.Add('    }');
...
begin
    ...
    try
        ...
        JsonList.Add('    "notes": "V26 first tries native BoardOutline vertices/points through late-bound API variants. If unavailable, it falls back to the validated native Board.BoardOutline.BoundingRectangle path from v25, then to all-object bounds."');
        JsonList.Add('  },');
...
begin
    ...
    try
        ...
        JsonList.Add('  "type": "schematic",');
        AddExporterMetadata(JsonList);
        JsonList.Add('  "schemaVersion": "v26",');
        JsonList.Add('  "exportGoal": "universalLogicalPlusGraphicsFallbackV26",');

{==============================================================================}
{ Altium Diff Studio - Exporter Script v33c                                         }
{                                                                              }
...
const
    SCRIPT_VERSION = 'v33c';
    SCHEMA_VERSION = 'ads-json-v33c';
    SCHEMATIC_SCHEMA_VERSION = 'v33c';
...
begin
    ...
    AppendExportLog('Added schematic sheet v33c: ' + FileName + ' components=' + IntToStr(CompCount) + ' wires=' + IntToStr(WireCount) + ' netLabels=' + IntToStr(NetCount) + ' ports=' + IntToStr(PortCount) + ' powerPorts=' + IntToStr(PowerCount));
end;
...
begin
    ...
    try
        ...
        JsonList.Add('  "compatibilityMode": "v33c-safe-sch-containers",');

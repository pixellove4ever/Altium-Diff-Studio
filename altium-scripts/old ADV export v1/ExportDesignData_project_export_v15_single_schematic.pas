...
// Helper function to escape special characters in JSON strings.
// Non-ASCII characters are escaped as \u00XX so generated files remain valid UTF-8/ASCII
// even when Altium TStringList.SaveToFile writes using the local Windows codepage.
...
// Backward-compatible wrapper: now exports all sheets into one project-level JSON file.

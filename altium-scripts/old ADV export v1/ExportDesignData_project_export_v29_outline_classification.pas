{==============================================================================}
{ Altium Diff Studio - Exporter Script v29                                         }
{                                                                              }
...
begin
    ...
    JsonList.Add('    "method": "widthHeuristicV29",');
    ...
    JsonList.Add('    "notes": "V29 tags each keepout edge. width <= 1.1mm is treated as boardOutlineCandidate; wider edges are kept as localKeepoutOrCutoutCandidate. The viewer can now draw candidate outline edges separately from mounting-hole/cutout keepouts."');
    JsonList.Add('  },');
...
begin
    ...
    JsonList.Add('    "scriptVersion": "v29",');
    JsonList.Add('    "schemaVersion": "ads-json-v29"');
    JsonList.Add('  },');
end;
...
begin
    ...
    JsonList.Add('      "schematicExportLevel": "logicalPlusFallbackGraphicsV29",');
...
begin
    ...
    try
        ...
        JsonList.Add('    "notes": "V29 keeps the validated native Board.BoardOutline.BoundingRectangle path and classifies boardOutlineEdges exported from eTrackObject/eArcObject on eKeepOutLayer. The viewer should prefer boardOutlineEdges where edgeClass=boardOutlineCandidate for the visible outline, while retaining localKeepoutOrCutoutCandidate for drill/mounting/cutout context."');
        JsonList.Add('  },');
...
begin
    ...
    try
        ...
        JsonList.Add('  "type": "schematic",');
        AddExporterMetadata(JsonList);
        JsonList.Add('  "schemaVersion": "v29",');
        JsonList.Add('  "exportGoal": "universalLogicalPlusGraphicsFallbackV29",');

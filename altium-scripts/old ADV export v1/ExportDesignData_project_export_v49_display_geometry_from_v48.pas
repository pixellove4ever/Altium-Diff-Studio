{==============================================================================}
{ Altium Diff Studio - Exporter Script v49                                           }
{                                                                              }
...
const
    SCRIPT_VERSION = 'v49';
    SCHEMA_VERSION = 'ads-json-v49';
    SCHEMATIC_SCHEMA_VERSION = 'v49';
...
begin
    ...
    JsonList.Add('      "schematicExportLevel": "logicalPlusDisplayGeometryV49",');
...
begin
    ...
    try
        ...
        CsvPath := GetProjectPath + TargetPrefix + ChangeFileExt(TargetFileName, '_sch_v49_display_geometry.csv');
        SummaryPath := GetProjectPath + TargetPrefix + ChangeFileExt(TargetFileName, '_sch_v49_display_geometry_summary.txt');
        Csv.SaveToFile(CsvPath);
        Summary.SaveToFile(SummaryPath);
...
begin
    ...
    try
        ...
        OutputFileNames.Add(GetProjectPath + TargetPrefix + ChangeFileExt(TargetFileName, '_sch_v49_display_geometry.csv'));
        OutputFileNames.Add(GetProjectPath + TargetPrefix + ChangeFileExt(TargetFileName, '_sch_v49_display_geometry_summary.txt'));

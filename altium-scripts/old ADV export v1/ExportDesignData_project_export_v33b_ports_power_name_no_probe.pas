{==============================================================================}
{ Altium Diff Studio - Exporter Script v33b                                         }
{                                                                              }
...
const
    SCRIPT_VERSION = 'v33b';
    SCHEMA_VERSION = 'ads-json-v33b';
    SCHEMATIC_SCHEMA_VERSION = 'v33b';
    PCB_OUTPUT_SUFFIX = '_pcb_v33b.json';
    constKindPcb = 'PCB';
...
begin
    ...
    JsonList.Add('      "schematicExportLevel": "logicalPlusFallbackGraphicsV33b",');
    JsonList.Add('      "graphicsNotes": "V33b keeps the stable logical export and reserves typed SCH containers for native graphic/symbol extraction. Symbol bodies remain pin-bounds fallbacks until each target Altium object API is validated.",');
    JsonList.Add('      "schemaUpgrade": {');
    JsonList.Add('        "version": "v33b",');
    ...
    begin
        ...
        JsonList.Add('          "text": "' + EscapeStr(PowerObj.Name) + '",');
...
begin
    ...
    try
        ...
        JsonList.Add('    "notes": "V33b keeps the validated native Board.BoardOutline.BoundingRectangle path, exports KeepOut outline edges, and computes arc-aware viewer-ready bounds so the display does not fall back to all-object extents. The viewer should prefer boardOutlineEdges where edgeClass=boardOutlineCandidate for the visible outline, while retaining localKeepoutOrCutoutCandidate for drill/mounting/cutout context."');
        JsonList.Add('  },');
...
begin
    ...
    try
        ...
        JsonList.Add('  "exportGoal": "universalLogicalPlusGraphicsFallbackV33b",');
        JsonList.Add('  "compatibilityMode": "v33b-safe-sch-containers",');

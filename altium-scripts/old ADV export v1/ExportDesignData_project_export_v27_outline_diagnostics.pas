...
begin
    ...
    { V27 outline strategy:
      ...
      3) Add a safe diagnostic/candidate export based on mechanical track segments
         that lie exactly on the native board-outline rectangle edges. This helps us
         identify the real drawing layer and the primitive pattern without breaking
         the production JSON export. }
    ...
    JsonList.Add('    "diagnosticNotes": "V27 keeps the safe native bounding rectangle and exports mechanical edge candidates near that rectangle. Use this to identify whether the true outline can be reconstructed from mechanical primitives while the BoardOutline vertex API remains unknown."');
    JsonList.Add('  },');
end;
...
begin
    ...
    JsonList.Add('    "scriptVersion": "v27",');
    JsonList.Add('    "schemaVersion": "ads-json-v27"');
    JsonList.Add('  },');
end;
...
begin
    ...
    JsonList.Add('      "schematicExportLevel": "logicalPlusFallbackGraphicsV27",');
...
begin
    ...
    try
        ...
        JsonList.Add('    "boardOutline": "nativeBoardOutlineBoundingRectanglePlusMechanicalEdgeDiagnostics",');
        JsonList.Add('    "polygons": "reserved",');
        JsonList.Add('    "splitPlanes": "reserved",');
        JsonList.Add('    "regions": "reserved",');
        JsonList.Add('    "notes": "V27 keeps the validated native Board.BoardOutline.BoundingRectangle path and adds boardOutlineDiagnostics.mechanicalEdgeSegments. Direct vertex APIs are still disabled because the tested names are not compile-compatible in this Altium version."');
        JsonList.Add('  },');
...
begin
    ...
    try
        ...
        JsonList.Add('  "type": "schematic",');
        AddExporterMetadata(JsonList);
        JsonList.Add('  "schemaVersion": "v27",');
        JsonList.Add('  "exportGoal": "universalLogicalPlusGraphicsFallbackV27",');

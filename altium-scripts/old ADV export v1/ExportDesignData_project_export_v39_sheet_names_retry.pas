{==============================================================================}
{ Altium Diff Studio - Exporter Script v39                                          }
{                                                                              }
...
const
    SCRIPT_VERSION = 'v39';
    SCHEMA_VERSION = 'ads-json-v39';
    SCHEMATIC_SCHEMA_VERSION = 'v39';
...
begin
    ...
    JsonList.Add('      "schematicExportLevel": "logicalPlusFallbackGraphicsV39",');
    JsonList.Add('      "graphicsNotes": "V39 keeps the stable logical export and reserves typed SCH containers for native graphic/symbol extraction. Symbol bodies remain pin-bounds fallbacks until each target Altium object API is validated.",');
    JsonList.Add('      "schemaUpgrade": {');
    JsonList.Add('        "version": "v39",');
    ...
    begin
        ...
        JsonList.Add('          "name": "' + EscapeStr(SheetSymbolObj.Name) + '",');
        JsonList.Add('          "fileName": "' + EscapeStr(SheetSymbolObj.FileName) + '",');
    ...
    JsonList.Add('        "notes": "V39 keeps the native eJunction pass, but adds an explicit fallback contract because this Altium version returned zero native junction objects on the AGMA project."');
    JsonList.Add('      },');
...
begin
    ...
    try
        ...
        JsonList.Add('  "exportGoal": "universalLogicalPlusGraphicsFallbackV39",');
        JsonList.Add('  "compatibilityMode": "v39-safe-sch-containers",');

{==============================================================================}
{ Altium Diff Studio - Exporter Script v28                                         }
{                                                                              }
...
begin
    ...
    JsonList.Add('    "scriptVersion": "v28",');
    JsonList.Add('    "schemaVersion": "ads-json-v28"');
    JsonList.Add('  },');
end;
...
begin
    ...
    JsonList.Add('      "schematicExportLevel": "logicalPlusFallbackGraphicsV28",');
...
begin
    ...
    try
        ...
        JsonList.Add('    "notes": "V28 keeps the validated native Board.BoardOutline.BoundingRectangle path and adds boardOutlineDiagnostics.mechanicalEdgeSegments. Direct vertex APIs remain disabled; boardOutlineEdges follows the InteractiveHTMLBOM strategy by reading eTrackObject/eArcObject on eKeepOutLayer."');
        JsonList.Add('  },');
...
begin
    ...
    try
        ...
        JsonList.Add('  "type": "schematic",');
        AddExporterMetadata(JsonList);
        JsonList.Add('  "schemaVersion": "v28",');
        JsonList.Add('  "exportGoal": "universalLogicalPlusGraphicsFallbackV28",');

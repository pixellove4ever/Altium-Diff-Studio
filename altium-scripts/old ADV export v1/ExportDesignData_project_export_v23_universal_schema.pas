...
begin
    ...
    JsonList.Add('    "scriptVersion": "v23",');
    JsonList.Add('    "schemaVersion": "ads-json-v23"');
    JsonList.Add('  },');
end;
...
begin
    ...
    JsonList.Add('      "schematicExportLevel": "logicalPlusFallbackGraphicsV23",');
    ...
    JsonList.Add('        "notes": "V23 stabilizes the universal schema. Native SCH primitive extraction should be enabled object family by object family after API validation in the target Altium version."');
    JsonList.Add('      }');
    JsonList.Add('    }');
...
begin
    ...
    try
        ...
        JsonList.Add('    "boardOutline": "boundingBoxFallbackUntilBoardShapeApiValidated",');
        JsonList.Add('    "polygons": "reserved",');
        JsonList.Add('    "splitPlanes": "reserved",');
        JsonList.Add('    "regions": "reserved",');
        JsonList.Add('    "notes": "V23 keeps plane/copper containers stable for comparison tools; enable native object extraction after validating constants/properties in the target Altium version."');
        JsonList.Add('  },');
...
begin
    ...
    try
        ...
        JsonList.Add('  "type": "schematic",');
        AddExporterMetadata(JsonList);
        JsonList.Add('  "schemaVersion": "v23",');
        JsonList.Add('  "exportGoal": "universalLogicalPlusGraphicsFallback",');

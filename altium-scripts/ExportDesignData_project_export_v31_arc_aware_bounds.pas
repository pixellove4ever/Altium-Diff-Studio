{==============================================================================}
{ Altium Diff Studio - Exporter Script v31                                         }
{                                                                              }
...
begin
    ...
    JsonList.Add('    "notes": "V31 tags each keepout edge and exports arc-aware viewer-ready render bounds. width <= 1.1mm is treated as boardOutlineCandidate; wider edges are kept as localKeepoutOrCutoutCandidate. Arc bounds now use the swept arc endpoints and cardinal extrema only when they lie inside the arc sweep."');
    JsonList.Add('  },');
...
begin
    ...
    JsonList.Add('    "scriptVersion": "v31",');
    JsonList.Add('    "schemaVersion": "ads-json-v31"');
    JsonList.Add('  },');
end;
...
begin
    ...
    JsonList.Add('      "schematicExportLevel": "logicalPlusFallbackGraphicsV31",');
...
begin
    ...
    try
        ...
        JsonList.Add('    "notes": "V31 keeps the validated native Board.BoardOutline.BoundingRectangle path, exports KeepOut outline edges, and computes arc-aware viewer-ready bounds so the display does not fall back to all-object extents. The viewer should prefer boardOutlineEdges where edgeClass=boardOutlineCandidate for the visible outline, while retaining localKeepoutOrCutoutCandidate for drill/mounting/cutout context."');
        JsonList.Add('  },');
...
begin
    ...
    try
        ...
        JsonList.Add('  "type": "schematic",');
        AddExporterMetadata(JsonList);
        JsonList.Add('  "schemaVersion": "v31",');
        JsonList.Add('  "exportGoal": "universalLogicalPlusGraphicsFallbackV31",');
